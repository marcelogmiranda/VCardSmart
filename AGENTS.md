...
- **Status lojas (09/09)**: **Android 1.0.6-14 na Google Play — testes aberto e fechado** (build `~/Downloads/VCardSmart-1.0.6-14.aab`); **iOS 1.0.6-14 submetido ao App Store Connect e disponível para testes (TestFlight)** — `~/Downloads/VCardSmart-1.0.6-14.ipa` (Export Compliance respondido como exempt; sem pendência de documento).
